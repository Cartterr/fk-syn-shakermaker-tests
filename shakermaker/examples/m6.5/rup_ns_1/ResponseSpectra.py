...
from normspectrum import Espectro2369
import numpy as np
...
Sah_2369,Sav_2369 = Espectro2369(S,To,Tprima,n,p,Ao,I,R,Rv,chi,chiv)
...
legend.append('NCh2369')
plt.plot(dt, Sav_2369,'k--')
