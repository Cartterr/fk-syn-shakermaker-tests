...
# Crear dos fuentes más cercanas a las estaciones
fuente1 = PointSource([4, 9, 1], [ϕ, θ, λ], tt=0, stf=stf)
fuente2 = PointSource([5, 19, 1], [ϕ, θ, λ], tt=0, stf=stf)
falla = FaultSource([fuente1, fuente2], metadata={"name": "fuentes_cercanas"})

# Crear modelo de corteza
